...
SEED_ACCOUNTS = [
    ...
    AccountConfig(name="内容号·深夜故事", dimension=Dimension.PURE_CONTENT,
                  monetizer=Monetizer.ADSHARE, persona="深夜情感故事主播",
                  cadence=AccountCadence.MEDIUM, bio="适合睡前听的故事", note="内容号"),
    ...
    AccountConfig(name="知识号·职场技能", dimension=Dimension.KNOWLEDGE,
                  monetizer=Monetizer.COURSE, persona="职场技能导师",
                  cadence=AccountCadence.HIGH, bio="职场效率与技能提升", note="知识号"),
    AccountConfig(name="知识号·学习笔记", dimension=Dimension.KNOWLEDGE,
                  monetizer=Monetizer.RESOURCE, persona="学习资料整理者",
                  cadence=AccountCadence.LOW, bio="高质量学习笔记与资料", note="知识号"),
    ...
    AccountConfig(name="工具号·效率办公", dimension=Dimension.SOFT_AD,
                  monetizer=Monetizer.TOOL, persona="办公效率专家",
                  cadence=AccountCadence.MEDIUM, bio="让办公效率翻倍的工具清单", note="工具号"),
    ...
    AccountConfig(name="资源号·素材合集", dimension=Dimension.KNOWLEDGE,
                  monetizer=Monetizer.RESOURCE, persona="素材合集分享者",
                  cadence=AccountCadence.HIGH, bio="设计/剪辑素材每日更新", note="资源号"),
    ...
    AccountConfig(name="产品号·行业案例", dimension=Dimension.SOFT_AD,
                  monetizer=Monetizer.SAAS, persona="行业案例分析师",
                  cadence=AccountCadence.LOW, bio="用真实案例讲清行业方案", note="产品号"),
]
